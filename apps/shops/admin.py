...
class ShopAdmin(admin.ModelAdmin):
    list_display = ['shop_code', 'shop_name', 'legal_name', 'phone_number', 'email', 'owner', 'default_shop', 'status', 'created_at']
    ...
    fieldsets = (
        ('Basic Info', {'fields': ('shop_code', 'shop_name', 'legal_name', 'owner')}),
